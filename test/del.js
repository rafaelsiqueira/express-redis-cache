(function () {
  ...
  describe ( 'del with wilcard and ignore string', function () {
  ...
  describe ( 'del with wilcard and ignore array', function () {
    ...
    it ( 'should be a 4', function () {
      deletions.should.be.eql(4);
    });
